              ...
              <div ref={ref} className='relative w-screen max-w-md'>
                ...
                */}
                <div className='absolute top-0 left-0 -ml-8 pt-4 pr-2 flex sm:-ml-10 sm:pr-4'>
                  <button aria-label='Close panel' onClick={() => setSidebarOpen(!sidebarOpen)} className='text-gray-800 hover:text-gray-500 text-3xl transition ease-in-out duration-150'>
                    {/* Heroicon name: x */}
