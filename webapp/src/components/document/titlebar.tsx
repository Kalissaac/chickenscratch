...
export default function DocumentTitlebar ({ setSidebarOpen, showBackButton = true, mode }: { setSidebarOpen: Function, showBackButton?: boolean, mode: EditorModes }): JSX.Element {
  ...
  return (
    <>
      <Transition show={showTitlebar} unmount={false} className='sticky top-0 z-10 p-6 flex justify-between items-center text-gray-800 dark:text-gray-50 text-2xl bg-white dark:bg-gray-900 bg-opacity-80 backdrop-blur'
